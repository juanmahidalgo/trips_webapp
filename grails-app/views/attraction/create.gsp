...
<html>
	...
	<body>
		<a href="#create-attraction" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-attraction" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:attractionInstance, action:'save']" >
				<fieldset class="form">

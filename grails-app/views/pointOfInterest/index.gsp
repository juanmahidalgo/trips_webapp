		...
		<div id="list-pointOfInterest" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="pointOfInterest.attraction.label" default="Attraction" /></th>
					
						<th><g:message code="pointOfInterest.audioGuide.label" default="Audio Guide" /></th>
					
						<th><g:message code="pointOfInterest.image.label" default="Image" /></th>
				...
				<g:each in="${pointOfInterestInstanceList}" status="i" var="pointOfInterestInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: pointOfInterestInstance, field: "attraction")}</td>
					
						<td>${fieldValue(bean: pointOfInterestInstance, field: "audioGuide")}</td>
					
						<td>${fieldValue(bean: pointOfInterestInstance, field: "image")}</td>
			...
			<div class="pagination">
				<g:paginate total="${pointOfInterestInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>

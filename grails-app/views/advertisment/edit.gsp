...
<html>
	...
	<body>
		<a href="#edit-advertisment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-advertisment" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:advertismentInstance, action:'update']" method="POST" >
				...
				<fieldset class="buttons">
					<g:actionSubmit class="save btn btn-update" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" />
				</fieldset>
			</g:form>
		</div>
	</body>

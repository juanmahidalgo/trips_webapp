		...
		<div id="list-route" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="route.city.label" default="City" /></th>
				...
				<g:each in="${routeInstanceList}" status="i" var="routeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${routeInstance.id}">${fieldValue(bean: routeInstance, field: "city")}</g:link></td>
					
						<td>${fieldValue(bean: routeInstance, field: "name")}</td>
